...
x_data = np.loadtxt(open("//lfs//xbrain//home//acctouhou//all_data//bn_elu//4//x_data","rb"),delimiter=" ",skiprows=0)
x_mean = np.loadtxt(open("//lfs//xbrain//home//acctouhou//all_data//bn_elu//4//x_mean","rb"),delimiter=" ",skiprows=0)
x_var = np.loadtxt(open("//lfs//xbrain//home//acctouhou//all_data//bn_elu//4//x_var","rb"),delimiter=" ",skiprows=0)
x_test = np.loadtxt(open("//lfs//xbrain//home//acctouhou//all_data//bn_elu//4//x_test","rb"),delimiter=" ",skiprows=0)
y_data = np.loadtxt(open("//lfs//xbrain//home//acctouhou//all_data//bn_elu//4//y_data","rb"),delimiter=" ",skiprows=0)
y_mean = np.loadtxt(open("//lfs//xbrain//home//acctouhou//all_data//bn_elu//4//y_mean","rb"),delimiter=" ",skiprows=0)
y_var = np.loadtxt(open("//lfs//xbrain//home//acctouhou//all_data//bn_elu//4//y_var","rb"),delimiter=" ",skiprows=0)
y_test = np.loadtxt(open("//lfs//xbrain//home//acctouhou//all_data//bn_elu//4//y_test","rb"),delimiter=" ",skiprows=0)
l_data=np.loadtxt(open("//lfs//xbrain//home//acctouhou//all_data//bn_elu//4//l_data","rb"),delimiter=" ",skiprows=0)
l_test=np.loadtxt(open("//lfs//xbrain//home//acctouhou//all_data//bn_elu//4//l_test","rb"),delimiter=" ",skiprows=0)  
...
bn2 = tf.nn.elu(tf.layers.batch_normalization(h1, training=train,epsilon=1e-9,momentum=0.999,beta_regularizer=tf.contrib.layers.l2_regularizer(aaa),gamma_regularizer=tf.contrib.layers.l2_regularizer(aaa)))
h2 = tf.matmul(bn2,W2) + b2
bn3 = tf.nn.elu(tf.layers.batch_normalization(h2, training=train,epsilon=1e-9,momentum=0.999,beta_regularizer=tf.contrib.layers.l2_regularizer(aaa),gamma_regularizer=tf.contrib.layers.l2_regularizer(aaa)))
h3 = tf.matmul(bn3,W3) + b3
bn4 = tf.nn.elu(tf.layers.batch_normalization(h3, training=train,epsilon=1e-9,momentum=0.999,beta_regularizer=tf.contrib.layers.l2_regularizer(aaa),gamma_regularizer=tf.contrib.layers.l2_regularizer(aaa)))
h4 = tf.matmul(bn4,W4) + b4
bn5 = tf.nn.elu(tf.layers.batch_normalization(h4, training=train,epsilon=1e-9,momentum=0.999,beta_regularizer=tf.contrib.layers.l2_regularizer(aaa),gamma_regularizer=tf.contrib.layers.l2_regularizer(aaa)))
h5 = tf.matmul(bn5,W5) + b5
bn6 = tf.nn.elu(tf.layers.batch_normalization(h5, training=train,epsilon=1e-9,momentum=0.999,beta_regularizer=tf.contrib.layers.l2_regularizer(aaa),gamma_regularizer=tf.contrib.layers.l2_regularizer(aaa)))
h6 = tf.matmul(bn6,W6) + b6
bn7 = tf.nn.elu(tf.layers.batch_normalization(h6, training=train,epsilon=1e-9,momentum=0.999,beta_regularizer=tf.contrib.layers.l2_regularizer(aaa),gamma_regularizer=tf.contrib.layers.l2_regularizer(aaa)))
