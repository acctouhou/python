...
x_data = np.loadtxt(open("x_data1","rb"),delimiter=" ",skiprows=0)
x_mean = np.loadtxt(open("x_mean1","rb"),delimiter=" ",skiprows=0)
x_var = np.loadtxt(open("x_var1","rb"),delimiter=" ",skiprows=0)
x_test = np.loadtxt(open("x_test1","rb"),delimiter=" ",skiprows=0)
y_data = np.loadtxt(open("y_data1","rb"),delimiter=" ",skiprows=0)
y_mean = np.loadtxt(open("y_mean1","rb"),delimiter=" ",skiprows=0)
y_var = np.loadtxt(open("y_var1","rb"),delimiter=" ",skiprows=0)
y_test = np.loadtxt(open("y_test1","rb"),delimiter=" ",skiprows=0)
l_data=np.loadtxt(open("l_data1","rb"),delimiter=" ",skiprows=0)
l_test=np.loadtxt(open("l_test1","rb"),delimiter=" ",skiprows=0)  
