...
for i in range(int(1e5)):
     _ = sess.run(step,feed_dict={handle:handle2,train:True,pp:0.8,aa:0})

     if(i%50==0):
         loss_v,error,local,temp,gg= sess.run([loss,test_loss,l,ans,y],feed_dict={handle:handle1,train:False,pp:1,aa:0.2})
         loss_t= sess.run(loss,feed_dict={handle:handle2,train:False,pp:1,aa:0.2})
         ...
         if(i%500==0):
             ...
             error,temp,gg = sess.run([test_loss,ans,y],feed_dict={handle:handle3,train:False,pp:1,aa:0.2})
